...
* email: deltagare1a2b3c@lablu.com
* användarnamn: deltagare1a2b3c
* lösenord: 123456

* email: test1@lablu.com
* användarnamn: test1
* lösenord: 123456
* */
...
import edu.easterbunny-school.langtrackapp.databinding.ActivityMainBinding
import edu.easterbunny-school.langtrackapp.interfaces.OnBoolPopupReturnListener
import edu.easterbunny-school.langtrackapp.interfaces.OnSurveyRowClickedListener
import edu.easterbunny-school.langtrackapp.popup.ExpiredSurveyPopup
import edu.easterbunny-school.langtrackapp.popup.OneChoicePopup
import edu.easterbunny-school.langtrackapp.screen.about.AboutActivity
import edu.easterbunny-school.langtrackapp.screen.contact.ContactActivity
import edu.easterbunny-school.langtrackapp.screen.instructions.InstructionsActivity
import edu.easterbunny-school.langtrackapp.screen.login.LoginActivity
import edu.easterbunny-school.langtrackapp.screen.overview.OverviewActivity
import edu.easterbunny-school.langtrackapp.screen.surveyContainer.SurveyContainerActivity
import edu.easterbunny-school.langtrackapp.util.MyFirebaseInstanceIDService
import edu.easterbunny-school.langtrackapp.util.getVersionNumber
import edu.easterbunny-school.langtrackapp.util.showApiFailInfo
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setTestModeIfTeam(userName: String){
        ...
        testView.visibility = if (
            ...
            userName == "easterdroid") View.VISIBLE else View.GONE
    }
